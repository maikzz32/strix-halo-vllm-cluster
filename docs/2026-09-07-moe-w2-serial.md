...
Before activation, the patch's dispatch boundaries still need explicit CPU tests. A fresh original/candidate/original full-model benchmark must then verify answer texts, token lengths and speculative acceptance as well as speed. The running service remains canonical TP4/UMA AVX2, run `084ab1d9d8364bc0835ad76e6e757500`. No full-model gain is claimed yet.
