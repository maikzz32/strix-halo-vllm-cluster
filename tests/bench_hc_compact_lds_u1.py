...
def main():
    ...
    assert hashlib.sha256(a.library.read_bytes()).hexdigest()=='762a857dafe81c27ea19aac79f54d8f4aaed2e9aa02374a293c08e2a0586d7af'
    import torch
    ...
    for n,k in ((10240,320),):
        ...
        methods=[0,3020,3040,3080,4020,6020,8040,8080,8120,9020,9040,9080]
        def call(grid,w):
