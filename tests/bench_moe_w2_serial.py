...
def main():
 ...
 def serial(bn,warps,**kw):
  assert kw['A'].shape==(40,160) and kw['top_k']==1 and kw['mul_routed_weight']
  w2_serial[(40,2560//bn)](kw['A'],kw['B'],kw['B_scale'],kw['B_zp'],kw['C'],kw['topk_weights'],kw['sorted_token_ids'],kw['expert_ids'],kw['num_tokens_post_padded'],40,160,N=2560,K=160,GS=32,TOPK=1,BM=16,BN=bn,BK=32,SPLITK=5,num_warps=warps,num_stages=1,enable_fp_fusion=False)
  return True
 variants={'installed':fm._glm53_moe_int4_gemv,'serial64w4':lambda **kw:serial(64,4,**kw),'serial32w2':lambda **kw:serial(32,2,**kw),'serial128w4':lambda **kw:serial(128,4,**kw)}
