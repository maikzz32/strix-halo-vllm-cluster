...
def main():
    ...
    assert hashlib.sha256(a.library.read_bytes()).hexdigest()=='cd31f096a2160847b01d282fff92e60854658a7242ee3080372b93d3d53d15dd'
    import torch
    ...
    report={'status':'running','cases':[],'note':'Synthetic BF16 weights, 24-matrix pools; Codes mode*1000+grid: mode5 compact U4/W16, mode6 compact U2/W16, mode7 compact U2/W8. Zero is installed reference. Grid is launch geometry, not physical CU count.'}
    for n,k in ((10240,320),):
        ...
        methods=[0,4020,4040,5020,5040,5080,6020,6040,6080,7040,7080,7120]
        def call(grid,w):
