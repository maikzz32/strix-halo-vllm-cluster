"""Rotating-expert W1 weight-cache-hint comparison; unchanged arithmetic."""
...
def main():
 ...
 from moe_w1_cache_kernel import w1_cg,w1_cv
 ...
 variants={'installed':fm._glm53_moe_int4_gemv,'cg':lambda **kw:cache_call(w1_cg,**kw),'cv':lambda **kw:cache_call(w1_cv,**kw)}
