...
def main():
 ...
 p=pathlib.Path('results/qwen029-tools-20260909.json');p.write_text(json.dumps(report,indent=2),encoding='utf-8');print('PASS: auto tool selection, result roundtrip, streamed tool call, default thinking')
