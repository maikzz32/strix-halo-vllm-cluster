...
test = (root / 'tests/check_pinned_norm_gate_geometry.py').read_text()
...
result.update(host=args.host, container=container,
              pin_module_sha256=hashlib.sha256((root / 'patches/pin_norm_gate_geometry.py').read_bytes()).hexdigest(),
