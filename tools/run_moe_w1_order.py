...
p=subprocess.run(['timeout','--signal=TERM','--kill-after=5s','150s','python3',str(root/'bench_moe_w1_order.py'),'--output',str(root/'result.json'),'--seed',str(cfg['seed'])],env=env,capture_output=True,timeout=160)
