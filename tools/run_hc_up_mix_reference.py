...
a=argparse.ArgumentParser();a.add_argument('--host',default='192.168.1.18',choices=['192.168.1.'+str(n) for n in range(15,19)]);a.add_argument('--output',type=Path,required=True);args=a.parse_args()
...
source=(root/'tests/check_hc_up_mix_reference.py').read_bytes()
