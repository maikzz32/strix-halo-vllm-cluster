...
modules={name:(root/'patches'/('hc_up_mix_audit.py' if name=='hc_up_mix_runtime.py' else name)).read_text() for name in ('hc_up_mix_runtime.py','hc_up_mix_source.py','hc_up_mix_dynamic.py','hc_first_mismatch.py')}
